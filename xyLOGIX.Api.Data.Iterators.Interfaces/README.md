...
iterates over a data set whose total number of items is not known in advance.
Each data item is referenced as an instance of `T`.

##### Generic Types

| Name | Description |
| ---- | ----------- |
| T | Name of a class that represents a single element of the
collection. |
